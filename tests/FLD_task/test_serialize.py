...
def test_serialize_example():
    ...
    facts = 'fact1: this is sentence1 fact2: this is sentence2 fact3: this is sentence3 fact4: this is sentence4 fact5: this is sentence5'
    ...
    test_one_example(
        ...
        [
            SerializedDeduction.parse_obj({
                'prompt': f'$facts$ = {facts} ; $hypothesis$ = {hypothesis} ; $proof$ = ',
                'partial_proof': None,
    ...
    test_one_example(
        ...
        [
            ...
            # n1 p1 n2
            # SerializedDeduction.parse_obj({
            #     'prompt': f'$facts$ = {facts} ; $hypothesis$ = {hypothesis} ; $proof$ = fact4 & fact5 -> int1: first negative conclusion; fact1 & fact2 -> int2: first conclusion;',
            #     'partial_proof': None,
